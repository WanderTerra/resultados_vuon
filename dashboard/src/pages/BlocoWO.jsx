        ...
        <div className="space-y-6 px-4">
            ...
            <section>
                <div className="mb-6">
                    ...
                    <p className="text-slate-500">Evolução mensal de clientes virgens, total de pagamentos e acordos no Bloco WO (mais de 360 dias de atraso)</p>
                </div>
                <ClientesVirgensChart bloco="wo" />
            </section>
        </div>
    );
};
